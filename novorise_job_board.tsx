...
function NovoRiseMain() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] font-sans text-slate-800 relative">
        ...
        <div className="fixed inset-0 z-50 bg-[#0B132B]/75 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto animate-fade-in">
          <div className="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative border border-slate-100 my-6">
            ...
            <div className="bg-gradient-to-r from-[#0B132B] via-[#1C2541] to-[#0B132B] text-white p-6 sm:p-8 relative overflow-hidden">
              <div className="absolute right-0 top-0 w-64 h-64 bg-[#FF9F1C]/15 rounded-full blur-3xl pointer-events-none" />
              ...
              <div className="flex items-start gap-4 pr-10 relative z-10">
                ...
                <div>
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#FF5E36]/20 text-[#FF9F1C] text-[11px] font-bold uppercase tracking-wider border border-[#FF5E36]/30 mb-1">
            ...
            <div className="p-6 sm:p-8">
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <span className="bg-orange-50 text-orange-700 text-xs font-semibold px-3 py-1.5 rounded-xl flex items-center gap-1.5 border border-orange-100">
              ...
              <div className="flex items-center justify-between gap-4 mt-6">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#FF9F1C] via-[#FF5E36] to-[#FF5E36] hover:from-[#e88b14] hover:to-[#e54a22] text-white px-8 py-3.5 rounded-2xl font-extrabold text-xs sm:text-sm shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 transition-all transform hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
                >
                  Postuler maintenant
                </button>
              </div>
      ...
      {applyJob && (
        <div className="fixed inset-0 z-50 bg-[#0B132B]/75 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto animate-fade-in">
          <div className="bg-white rounded-3xl max-w-lg w-full shadow-2xl overflow-hidden border border-slate-100 relative my-6">
            ...
            <div className="bg-gradient-to-r from-[#0B132B] via-[#1C2541] to-[#0B132B] text-white p-6 sm:p-7 relative overflow-hidden">
              ...
              <div className="relative z-10 pr-8">
                <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-[#FF9F1C]/20 text-[#FF9F1C] text-[11px] font-bold uppercase tracking-wider border border-[#FF9F1C]/30 mb-2">
                  <Sparkles className="w-3 h-3" /> Candidature directe
                </span>
                <h3 className="text-xl sm:text-2xl font-extrabold text-white tracking-tight">{applyJob.title}</h3>
                <p className="text-slate-300 text-xs sm:text-sm mt-1 font-medium">{applyJob.company} • {applyJob.location}</p>
              </div>
            </div>
            ...
            <div className="p-6 sm:p-7">
              <form onSubmit={(e) => {
                ...
                <div>
                  <label className="block font-bold text-slate-700 mb-1.5">Nom complet *</label>
                  <input 
                    type="text" 
                    required 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block font-bold text-slate-700 mb-1.5">Téléphone *</label>
                    <input 
                      type="tel" 
                      required 
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                  {/* CV Upload */}
                  <div>
                    <label className="block font-bold text-slate-700 mb-1.5">CV (Tous formats) *</label>
                    <div className="border-2 border-dashed border-orange-200/80 rounded-2xl p-4 text-center hover:border-[#FF9F1C] bg-orange-50/30 hover:bg-orange-50/60 transition-all cursor-pointer relative">
                      <input 
                        type="file" 
                      ...
                      />
                      <div className="w-8 h-8 rounded-lg bg-orange-100/70 text-[#FF9F1C] flex items-center justify-center mx-auto mb-1.5">
                      ...
                      <span className="text-[10px] text-slate-500 mt-0.5 block">Format libre</span>
                    </div>
                  </div>

                  {/* Lettre de Motivation Upload */}
                  <div>
                    <label className="block font-bold text-slate-700 mb-1.5">Lettre de Motivation (Optionnel)</label>
                    <div className="border-2 border-dashed border-blue-200/80 rounded-2xl p-4 text-center hover:border-[#2D6BE4] bg-blue-50/30 hover:bg-blue-50/60 transition-all cursor-pointer relative">
                      <input 
                        type="file" 
                        accept=".pdf,.doc,.docx,.odt,.rtf,.txt,.jpg,.jpeg,.png,.webp,application/pdf,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,image/*"
                        onChange={(e) => {
                        ...
                        className="absolute inset-0 w-full h-full opacity-0 cursor-pointer z-10"
                      />
                      <div className="w-8 h-8 rounded-lg bg-blue-100/70 text-[#2D6BE4] flex items-center justify-center mx-auto mb-1.5">
                        <FileText className="w-4 h-4" />
                      </div>
                      <span className="text-xs font-bold text-slate-800 block truncate">
                ...
                <div>
                  <label className="block font-bold text-slate-700 mb-1.5">Message pour le recruteur (optionnel)</label>
                  <textarea 
                    rows={3}
